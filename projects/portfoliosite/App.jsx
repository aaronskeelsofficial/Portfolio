...
const BlogHeaderProps_ReplitTransfer = {
  id: "",
  text: "6. Replit Host Transfer",
  fontfamily: "",
  fontsize: "",
  fontweight: "",
  color: "",
...
const BlogTextProps_ReplitTransfer = {
  id: "",
  text: "Originally, Replit was used as repo and host. Their pricing scheme shifted drastically, and as such GitHub and GitHub Pages became the new <a href=\\\"https://github.com/aaronskeelsofficial/Portfolio\\\">repo</a> and <a href=\\\"https://aaronskeelsofficial.github.io/Portfolio\\\">host</a>. With it, I had to learn about how to properly build with Vite, how to configure GitHub Action workspaces, and how to deploy to GitHub Pages. This transfer not only provides a more reliable host in terms of uptime, but more reliable in terms of service lifetime as well as absurdly faster CDNs/servers.",
  fontfamily: "",
  fontsize: "",
  fontweight: "",
  color: "",
...
export default function App() {
  return (
    <>
      ...
      <BlogHeader {...BlogHeaderProps_ReplitTransfer} />
      <BlogText {...BlogTextProps_ReplitTransfer} />
      <BlogFooterGap />
    </>
  )
}
