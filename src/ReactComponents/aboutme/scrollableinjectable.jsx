...
//Props Format
/*
const ScrollableInjectableProps = {
  id: "",
  targetid: "",
  //
  enablepc: "true",
      ...
      <Helmet>
        <script>{`
          (function () {
            ...
            if (typeof window.aaron.aboutme.scrollableinjectable == "undefined")
              window.aaron.aboutme.scrollableinjectable = new Object();
          })();
          ...
          if (((deviceType == "pc" || deviceType == "tablet") && `+ props.enablepc + ` == true)
            ...
            AddElems = function () {
              ...
              baseelem.classList.add("scrollableinjectable");
              ...
              if (deviceType == "pc" || deviceType == "tablet") {
                baseelem.innerHTML = "`+props.injectablepc+`";
              } else {
                baseelem.innerHTML = "`+props.injectablephone+`";
              }

              let targetid = "`+props.targetid+`";
              targetid = (targetid == "") ? "scrollablebody" : targetid;
