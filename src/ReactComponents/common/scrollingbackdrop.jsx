...
/*
 * THIS CLASS NAME DOESN'T SUGGEST IT, BUT THIS HAS BEEN GRANDFATHERED IN VIA TECH DEBT
 * TO SPECIFICALLY BE THE COMPONENT USED FOR THE SCROLLING STARS BACKGROUND.
 */

//Props Format
/*
const ScrollingBackdropProps = {
  id: "",
  src: "",
  naturalwidth: "",
  naturalheight: "",
        ...
        <script>{`
          ...
          if (((deviceType == "pc" || deviceType == "tablet") && `+ props.enablepc + ` == true)
            ...
            AddElems = function () {
              ...
              star1.style.top = "0px";
              star1.style.width = "100%";
              star1.style.height = "auto";
              //
              star1.ondragstart = () => {
                return false;
              };
